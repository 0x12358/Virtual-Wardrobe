          ...
          <div className="user-dropdown">
            <div className="user-dropdown-header">
              <div className="user-info">
                <div className="user-name">{user?.name || 'AI Stylist'}</div>
            ...
            <div className="user-dropdown-menu">
              ...
              <button className="dropdown-item" onClick={() => setIsDropdownOpen(false)}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                  <path 
                    d="M19 14C19 15.1046 18.1046 16 17 16H7C5.89543 16 5 15.1046 5 14V10C5 8.89543 5.89543 8 7 8H17C18.1046 8 19 8.89543 19 10V14Z" 
                    stroke="currentColor" 
                    strokeWidth="2" 
                    strokeLinecap="round" 
                    strokeLinejoin="round"
